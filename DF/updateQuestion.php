...
if(isset($_POST['done'])){
   ...
   $date = date("Y/m/d");
   $id= $_POST['id'];
    $q ="update `questions` set `date`='$date',`Question`='$Question',`uid`='$uid',`Status`='0' where id='$id'";
//    die($q);
            ...
            <form method="post">
                ...
                <div class="card">
                    <div class="card-header bg-dark">
                        <h1 class="text-white text-center"> Question</h1>
                    </div>
                    <br>    
                    ...
                    <button class="btn btn-success" type="submit" name="done">Update Question</button>
                    <br>        
            </form>
        </div>
    </body>
